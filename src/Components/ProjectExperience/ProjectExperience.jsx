    ...
    <div>
      <div>
        ...
        <p className={css.about}>
          This project is my last homework, here I used all my knowledge
          from the HTML/CSS course
        </p>
      </div>
      <div>
        <ul className={css.list}>
      ...
      <div>
        ...
        <p className={css.about}>
          In this project, I was responsible for the "Add a pet" form and
          all of the backend logic for it
        </p>
      </div>
    </div>
  </section>
